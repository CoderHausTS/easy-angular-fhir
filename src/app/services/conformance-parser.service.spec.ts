...
describe('ConformanceParserService', () => {
  ...
  MockAppConstants.settings = {
    ...
    fhir: {
      ...
      clientId: 'mock-mock-mock-mock-mock',
  ...
  beforeEach(() => {
    ...
    backend
      .expectOne(AppConfigService.settings.fhir.baseURL + 'metadata')
      .flush(mockConformanceData);
  });
  ...
  it('should return the proper data URL', () => {
    expect(service.getUrl()).toEqual(mockConformanceData.url);
  });

  it('should return the proper FHIR version', () => {
    expect(service.getFhirVersion()).toEqual(mockConformanceData.fhirVersion);
  });

  it('should return the proper EHR software version information', () => {
    const versionObject = {
      name: mockConformanceData.software.name,
      version: mockConformanceData.software.version,
      releaseDate: mockConformanceData.software.releaseDate,
    };
